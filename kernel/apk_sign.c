...
static apk_sign_key_t apk_sign_keys[] = {
	...
	{ EXPECTED_SIZE_YUKISU_FIRST, EXPECTED_HASH_YUKISU_FIRST }, // YukiSU First Manager
	{ EXPECTED_SIZE_YUKISU_SECOND, EXPECTED_HASH_YUKISU_SECOND }, // YukiSU Second Manager
#ifdef EXPECTED_SIZE
